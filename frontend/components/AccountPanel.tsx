...
import { useMyCaseCount } from "@/lib/hooks/useDisputeArbitration";
...
export function AccountPanel() {
  ...
  const caseCount = useMyCaseCount(address);
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        ...
        <DialogContent className="brand-card border-2">
          <DialogHeader>
            ...
            <DialogDescription>
              Connect your MetaMask wallet to create and resolve agreements
            </DialogDescription>
          </DialogHeader>
      ...
      <div className="flex items-center gap-4">
        <div className="brand-card px-4 py-2 flex items-center gap-3">
          ...
          <div className="flex items-center gap-1">
            <span className="text-sm font-semibold text-accent">{caseCount}</span>
      ...
      <DialogContent className="brand-card border-2">
        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="brand-card p-4 space-y-2">
            ...
            <p className="text-2xl font-bold text-accent">{caseCount}</p>
          </div>
