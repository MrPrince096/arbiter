...
import { useAgreements } from "@/lib/hooks/useDisputeArbitration";
...
export function Navbar() {
  ...
  const disputedAgreements = agreements?.filter((a) => a.status === "disputed").length || 0;
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg md:text-xl font-bold ml-2">Arbiter</span>
              </div>
              ...
              <div className="hidden md:flex items-center gap-6 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-foreground font-bold text-accent">{totalAgreements}</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-muted-foreground">Disputed:</span>
                  <span className="text-foreground font-bold text-accent">{disputedAgreements}</span>
                </div>
              </div>
